    ...
    return (
        <div className="App">
            <main>
                ...
                Lancez jusqu'à ce que tous les dés soient identiques. Cliquez sur chaque dé pour figer
                     à sa valeur actuelle entre les lancers.
                </p>
                <h2 className="track-rolls">Nombre de lancé: <strong style={{color:'gray'}}>{numOfRolls}</strong></h2>
                <div className="timer">
